...
def process_row(row, skill_info_dict, knowledge_df, lock, client):
    ...
    proficiency_level_with_reason = get_proficiency_level(skill_title, proficiency_info, course_description, course_learning, course_title, 3, client) # course_learning
    ...
    try:
        ...
        print(f"""{res_dict["Course Reference Number"]}: {res_dict["proficiency_level"]}""")
    except:
        print("Error")
        res_dict = {}
        res_dict["Skill Title"] = row["Skill Title"]
