...
def process_uploaded_files(
    ...
    # # Initialize dialog state if not exists (COMMENTED OUT - AI DIALOG DISABLED)
    ...
    # # Show dialog if needed (COMMENTED OUT - AI DIALOG DISABLED)
    # if st.session_state.show_ai_dialog:
    #     show_ai_consent_dialog()

    # Handle processing trigger - Direct processing without AI consent dialog
    ...
    if process_clicked:
        ...
        # # Show AI consent dialog first if consent not given (COMMENTED OUT - AI DIALOG DISABLED)
        # if not st.session_state.ai_consent_given:
        #     st.session_state.show_ai_dialog = True
        #     st.rerun()
        #     return

        # DIRECT PROCESSING - Skip AI consent dialog
        logger.info(
            "🔒 LOCKING PROCESSING STATE - Setting st.session_state.processing = True"
        )
    ...
    # # Process data if consent given and processing triggered (COMMENTED OUT - AI DIALOG DISABLED)
